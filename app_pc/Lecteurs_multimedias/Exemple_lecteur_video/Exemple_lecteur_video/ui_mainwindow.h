...
**
** Created: Tue 15. May 17:18:52 2012
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(400, 392);
        centralWidget = new QWidget(MainWindow);
        centralWidget->setObjectName(QString::fromUtf8("centralWidget"));
        verticalLayoutWidget = new QWidget(centralWidget);
        verticalLayoutWidget->setObjectName(QString::fromUtf8("verticalLayoutWidget"));
        verticalLayoutWidget->setGeometry(QRect(0, 260, 321, 51));
        ...
        horizontalLayoutWidget->setGeometry(QRect(0, 310, 179, 80));
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8("../../Exemple_lecteur_musique/img_lecteur/jouer-a-droite-fleche-icone-6822-32.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8("../../Exemple_lecteur_musique/img_lecteur/pause-icone-4803-32.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8("../../Exemple_lecteur_musique/img_lecteur/arreter-icone-7083-32.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        verticalLayoutWidget_2->setGeometry(QRect(320, 260, 81, 51));
        ...
        horizontalLayoutWidget_2->setGeometry(QRect(240, 310, 160, 80));
        ...
        label->setPixmap(QPixmap(QString::fromUtf8("../../Exemple_lecteur_musique/img_lecteur/joueur-volume-icone-9860-32.png")));

        hLayoutVolume->addWidget(label);

        verticalLayoutWidget_3 = new QWidget(centralWidget);
        verticalLayoutWidget_3->setObjectName(QString::fromUtf8("verticalLayoutWidget_3"));
        verticalLayoutWidget_3->setGeometry(QRect(-1, -1, 401, 261));
        vLayoutVideo = new QVBoxLayout(verticalLayoutWidget_3);
        vLayoutVideo->setSpacing(6);
        vLayoutVideo->setContentsMargins(11, 11, 11, 11);
