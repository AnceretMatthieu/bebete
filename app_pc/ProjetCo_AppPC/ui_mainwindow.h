...
public:
    ...
    QPushButton *button_addQuestion;
    ...
    QPushButton *button_ajouterResult;
    QPushButton *button_modifierResult;
    QPushButton *button_supprimerResult;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        button_addQuestion = new QPushButton(centralWidget);
        button_addQuestion->setObjectName(QString::fromUtf8("button_addQuestion"));
        QFont font1;
        font1.setFamily(QString::fromUtf8("MS Shell Dlg 2"));
        font1.setPointSize(10);
        button_addQuestion->setFont(font1);
        QIcon icon1;
        icon1.addFile(QString::fromUtf8("images/icon_ajouter.png"), QSize(), QIcon::Normal, QIcon::Off);
        button_addQuestion->setIcon(icon1);

        horizontalLayout_6->addWidget(button_addQuestion);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8("images/icon_modifier.png"), QSize(), QIcon::Normal, QIcon::Off);
        button_modifierQuestion->setIcon(icon2);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8("images/icon_supprimer.png"), QSize(), QIcon::Normal, QIcon::Off);
        button_supprimerQuestion->setIcon(icon3);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8("images/icon_ajouter_media.png"), QSize(), QIcon::Normal, QIcon::Off);
        button_ajouterMediaQuestion->setIcon(icon4);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8("images/icon_ajouter_commentaire.png"), QSize(), QIcon::Normal, QIcon::Off);
        button_ajouterComQuestion->setIcon(icon5);
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8("images/icon_modif_media.png"), QSize(), QIcon::Normal, QIcon::Off);
        button_modifierMediaQuestion->setIcon(icon6);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8("images/icon_suppr_media.png"), QSize(), QIcon::Normal, QIcon::Off);
        button_supprimerMediaQuestion->setIcon(icon7);
        ...
        button_ajouterReponse->setIcon(icon1);
        ...
        button_modifierReponse->setIcon(icon2);
        ...
        button_supprimerReponse->setIcon(icon3);
        ...
        button_ajouterMediaReponse->setIcon(icon4);

        horizontalLayout_8->addWidget(button_ajouterMediaReponse);
        ...
        button_ajouterComMediaReponse->setIcon(icon5);
        ...
        button_modifierMediaReponse->setIcon(icon6);
        ...
        button_supprimerMediaReponse->setIcon(icon7);
        ...
        button_ajouterResult = new QPushButton(centralWidget);
        button_ajouterResult->setObjectName(QString::fromUtf8("button_ajouterResult"));
        button_ajouterResult->setFont(font1);

        horizontalLayout_9->addWidget(button_ajouterResult);

        button_modifierResult = new QPushButton(centralWidget);
        button_modifierResult->setObjectName(QString::fromUtf8("button_modifierResult"));
        button_modifierResult->setFont(font1);

        horizontalLayout_9->addWidget(button_modifierResult);

        button_supprimerResult = new QPushButton(centralWidget);
        button_supprimerResult->setObjectName(QString::fromUtf8("button_supprimerResult"));
        button_supprimerResult->setFont(font1);

        horizontalLayout_9->addWidget(button_supprimerResult);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        button_addQuestion->setText(QApplication::translate("MainWindow", "Ajouter une question", 0, QApplication::UnicodeUTF8));
        ...
        button_ajouterMediaReponse->setText(QApplication::translate("MainWindow", "Ajouter m\303\251dia", 0, QApplication::UnicodeUTF8));
        button_ajouterComMediaReponse->setText(QApplication::translate("MainWindow", "Ajouter commentaire", 0, QApplication::UnicodeUTF8));
        button_modifierMediaReponse->setText(QApplication::translate("MainWindow", "Modifier m\303\251dia", 0, QApplication::UnicodeUTF8));
        button_supprimerMediaReponse->setText(QApplication::translate("MainWindow", "Supprimer m\303\251dia", 0, QApplication::UnicodeUTF8));
        button_ajouterResult->setText(QApplication::translate("MainWindow", "Ajouter r\303\251sultat", 0, QApplication::UnicodeUTF8));
        button_modifierResult->setText(QApplication::translate("MainWindow", "Modifier r\303\251sultat", 0, QApplication::UnicodeUTF8));
        button_supprimerResult->setText(QApplication::translate("MainWindow", "Supprimer r\303\251sultat", 0, QApplication::UnicodeUTF8));
