...
public:
     ...
     *  \brief permet de sauvegarder l'arbre en mÈmoire dans un fichier XML
     *  \param Categorie * racine : la categorie ‡ remplir
     *  \param QString filePath : chemin du fichier XML ‡ produire
     */
    static void enregistrerArbre(Categorie *racine, QString filePath);

    /**
     *  \fn static void enregistrerCategorie(Categorie * currentCat)
     *  \brief enregistre la categorie passÈe en parametre dans le noeud courrant
