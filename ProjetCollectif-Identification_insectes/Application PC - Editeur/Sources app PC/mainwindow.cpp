...
/* TODO :
        - gérer l'ajout en mémoire des médias des réponses
 */
...
void MainWindow::supprimerQuestion()
{
    ...
    if(reponse == QMessageBox::Yes)
    {
        ...
        if(currentQuestion->getCat() != NULL)
        {
        ...
        {
            QMessageBox::warning(this, "Erreur", "Attention, vous ne pouvez pas supprimer une question à la racine de l'arbre de décision.");
        }
    }
}
...
void MainWindow::newReponse()
{
    ...
    if(ui->treeViewQuestion->currentIndex().isValid() == true) // si une question est selectionnée
    {
    ...
    {
        QMessageBox::warning(this, "Pas de question sélectionnée", "Attention, vous devez d'abord sélectionner une question avant de pouvoir ajouter une réponses.");
    }
}
...
{
    QMessageBox::warning(this, "Fonctionnalité manquante", "Vous ne pouvez pas encore modifier les médias d'une réponse.");
}

void MainWindow::supprimerMediaReponse()
{
    QMessageBox::warning(this, "Fonctionnalité manquante", "Vous ne pouvez pas encore supprimer les médias d'une réponse.");
}
...
void MainWindow::newResultat()
{
    ...
    if(index.parent() == QModelIndex()) // si l'élément courant n'a pas de parent
    {
        if(r->getTypeSuiv() == TYPE_EMPTY)
        {
        ...
        else if(r->getTypeSuiv() == TYPE_CATEGORIE)
        {
            QMessageBox::warning(this, "Erreur", "La réponse sélectionnée possède déjà une question suivante.");
        }
        else if(r->getTypeSuiv() == TYPE_ESPECE)
        {
            QMessageBox::warning(this, "Erreur", "La réponse sélectionnée possède déjà un résultat.");
        }
    }
    else
    {
        QMessageBox::warning(this, "Erreur", "Vous ne pouvez pas ajouter de résultat sur un média.");
    }
}
...
void MainWindow::modifierResultat()
{
    ...
    if(index.parent() == QModelIndex()) // si l'élément courant n'a pas de parent
    {
        ...
        else if(r->getTypeSuiv() == TYPE_EMPTY)
        {
            QMessageBox::warning(this, "Erreur", "La réponse sélectionnée ne possède pas résultat.");
        }
    }
    else
    {
        QMessageBox::warning(this, "Erreur", "L'élément courant est un média et il ne peut donc pas contenir de résultat.");
    }
}
...
void MainWindow::supprimerResultat()
{
    ...
    {
        QMessageBox::warning(this, "Erreur, suppression de résultat impossible", "L'élément courant est un média et il ne peut donc pas contenir de résultat.");
    }
}
