 ...
 *  \class Reponse
 *  \file Reponse.h
 *  \brief classe gerant une réponse avec sa description
 */
class Reponse {
    ...
    public:
         ...
         *  \brief ajoute un media pour illustrer le résultat
         ...
         *  \brief supprime le media des résultats
         ...
         *  \brief supprime le media des résultats en fonction de son id
