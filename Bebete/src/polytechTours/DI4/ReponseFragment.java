...
{	
	...
	public void onActivityCreated (Bundle savedInstanceState)
	{
		...
		if( reponse != null )
		{
			...
			Gallery gallery = (Gallery)this.getView().findViewById(R.id.gallery1); // pour obtenir la galerie relative à la question et pas toujours la même commune connue de activités
