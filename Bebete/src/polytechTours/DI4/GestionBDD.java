...
//en cas de probleme avec le coherence de la table :
...
public class GestionBDD extends SQLiteOpenHelper {
	...
	private static final String CREATE_RECOLOTE_DB = 
			"CREATE TABLE " + 
					TABLE_RECOLTE + "(" +
					COL_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + 
	...
	public void onCreate(SQLiteDatabase db){	
		db.execSQL(CREATE_USER_DB); //creation de la table utilisateur
		db.execSQL(CREATE_CAMPAGNE_DB); //creation de la table campagne
		db.execSQL(CREATE_PARCEL_DB); //creation de la table parcel
		db.execSQL(CREATE_PIEGE_DB); //creation de la table piege
		db.execSQL(CREATE_RECOLOTE_DB); //creation de la table piege
	}
	
	@Override
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		// On detruit et on recrée la table
